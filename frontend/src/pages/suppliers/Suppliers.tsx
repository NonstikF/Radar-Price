...
import {
    ...
    Search, Package, Square, CheckSquare
} from 'lucide-react';
...
export function Suppliers() {
    ...
    // --- ASIGNACIÓN MASIVA ---
    const openBulkModal = (s: Supplier) => {
        setBulkSupplierId(s.id);
        setBulkSupplierName(s.name);
        ...
        <div className="w-full max-w-6xl mx-auto p-4 md:p-6 pb-24 animate-fade-in">
            ...
            {loading ? (
                ...
                <div className="space-y-3">
                    {suppliers.map((s) => (
                        <div key={s.id} className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-transparent flex items-center gap-4 group hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-all">
                            {/* ICONO */}
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <div className="flex flex-wrap gap-2 mt-1 text-xs text-gray-500 dark:text-gray-400">
                                    <span className="bg-gray-100 dark:bg-gray-900 px-2 rounded font-mono">{s.rfc}</span>
                            ...
                            <div className="flex items-center gap-1 shrink-0">
                                <button onClick={() => openBulkModal(s)} title="Asignar productos" className="p-2 rounded-lg text-emerald-500 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition-colors">
                        ...
                        <div className="flex-1 overflow-y-auto p-4 space-y-1">
                            {loadingUnassigned ? (
                                ...
                                <>
                                    ...
                                    >
                                        {selectedProductIds.size === unassignedProducts.length
                                    ...
                                    {unassignedProducts.map((p) => (
                                        <div
                                            ...
                                            className={`flex items-center gap-3 p-3 rounded-xl cursor-pointer transition-all ${selectedProductIds.has(p.id)
                        ...
                        <div className="p-4 border-t border-gray-100 dark:border-gray-700 shrink-0">
                            ...
                            >
                                {assigning
                                    ...
                                    : <>
                                        <Package className="w-5 h-5" />
                                        Asignar {selectedProductIds.size > 0 ? `${selectedProductIds.size} productos` : ''}
                                    </>
                                }
                            </button>
                        </div>
