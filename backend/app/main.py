...
from datetime import (
    ...
    timedelta,
    timezone,
)  # Added timezone for non-deprecated UTC
...
# --- IMPORTS ---
# Ensure app.core.database defines 'engine' and 'Base'.
# 'Base' should be defined in app.core.database to avoid circular imports.
...
# --- 2. DATABASE MODELS ---
# UserDB inherits from the Base imported from app.core.database
class UserDB(Base):
    __tablename__ = "users"
...
origins = [
    ...
    "*",  # Helpful for development if specific origins fail
]
...
async def login_for_access_token(
    ...
    if not user and form_data.username == "admin":
        ...
        # Check if database is empty of users
